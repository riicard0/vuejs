    ...
    <v-container fluid>
          ...
          <v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <div style="width: 120px">
                <v-slider v-model="slider2" color="yellow" track-color="yellow">

                </v-slider>
              </div>
              <h4 class="mt-n4">I Am a Creative Web Design</h4>
              <h4>And Developer</h4>
              <p class="text-grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias et at nemo ut ad, quo
                corrupti ullam praesentium animi eius aliquid fugiat nihil voluptates nulla? Enim saepe provident
                perspiciatis assumenda.
              </p>
              <br />
              <p class="text-grey">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Assumenda ipsa, incidunt impedit, facere
                doloribus recusandae natus tenetur mollitia accusantium a quibusdam inventore? Ipsum numquam fugit culpa
                alias suscipit. Praesentium, aperiam.
              </p>
      ...
      <div class="text-center mt-4">
        ...
        <div style="width: 120px; margin: 0 auto">
          <v-slider v-model="slider2" color="yellow" track-color="yellow"></v-slider>
        </div>
      </div>
          ...
          <v-row>
            <v-col cols="12">
              ...
              <div class="child">
                ...
                <h3 class="ml-3 mt-4">Photoshop</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit amet <br />consectetur adipisicing
                  <br />consectetur adipis
                </p>
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" variant="tonal">Illustration</v-btn>
        </div>
      </v-col>
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                ...
                <v-card-text>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe eaque dolorum, placeat hic harum
                  suscipit.
                </v-card-text>
              </v-card>
            </v-col>
        ...
        <div class="hire">
          <v-row>
            <v-col cols="12" sm="8">
              ...
              <p class="text-grey">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cumque cum voluptate
                doloribus? Totam ducimus eius harum, obcaecati exercitationem at veniam officiis accusamus voluptas
                quibusdam placeat voluptate reprehenderit recusandae, qui quisquam!
              </p>
            </v-col>
            <v-col cols="12" sm="4">
        ...
        <v-row>
          ...
          <v-col cols="12" sm="8">
            ...
            <span class="text-caption">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint tempora necessitatibus quaerat earum minima
              voluptas harum reprehenderit facilis pariatur, explicabo voluptates asperiores modi eius nostrum quam?
              Excepturi hic suscipit tempore.
            </span>
            <v-row class="mt-10">
              <v-col cols="12" sm="6">
